...
PDC_OFFICIAL_SERIES_PROFILES = _build_series_profiles(
    {
        ...
        "FCF": ("PDC FCF 通用厚膜贴片电阻/低阻电流检测贴片电阻", "厚膜电阻", "通用厚膜 | 电流检测 | 低阻"),
        "WCF": ("PDC WCF 宽端子高功率厚膜贴片电阻（AEC-Q200）", "厚膜电阻", "宽端子 | 高功率 | AEC-Q200"),
        "AVF": ("PDC AVF 高压抗硫化厚膜贴片电阻（AEC-Q200）", "厚膜电阻", "高压 | 抗硫化 | AEC-Q200"),
        "AVS": ("PDC AVS 高压安规抗硫化厚膜贴片电阻（AEC-Q200）", "厚膜电阻", "高压 | 安规 | 抗硫化 | AEC-Q200"),
        "FAF": ("PDC FAF 高精密薄膜贴片电阻", "薄膜电阻", "高精密 | 薄膜"),
        "FBF": ("PDC FBF 低阻厚膜电流检测贴片电阻", "厚膜电阻", "电流检测 | 低阻 | 厚膜"),
        "FNF": ("PDC FNF 抗浪涌厚膜贴片电阻（AEC-Q200）", "厚膜电阻", "抗浪涌 | AEC-Q200"),
        "FOF": ("PDC FOF 金属箔高功率抗硫化电流检测电阻", "合金电阻", "电流检测 | 金属箔 | 抗硫化"),
        "FPF": ("PDC FPF 高功率厚膜贴片电阻", "厚膜电阻", "高功率 | 厚膜"),
        "FPS": ("PDC FPS 抗浪涌高功率厚膜贴片电阻", "厚膜电阻", "高功率 | 抗浪涌 | 厚膜"),
        "FVF": ("PDC FVF 高压厚膜贴片电阻", "厚膜电阻", "高压 | 厚膜"),
        "FVS": ("PDC FVS 高压安规厚膜贴片电阻", "厚膜电阻", "高压 | 安规 | 厚膜"),
        "FWF": ("PDC FWF 车规厚膜贴片电阻/抗硫化车规厚膜贴片电阻", "厚膜电阻", "车规 | 厚膜 | 抗硫化"),
        "FHF": ("PDC FHF 高阻值厚膜贴片电阻", "厚膜电阻", "高阻值 | 厚膜"),
    }
)
